...
describe('TaxiwayLocationComponent', () => {
    ...
    let formValueChangesSubject: Subject<any>
    ...
    beforeEach(async () => {
        ...
        formValueChangesSubject = new Subject<any>()
        ...
        Object.defineProperty(parentForm, 'valueChanges', {
            get: () => formValueChangesSubject.asObservable()
        })
