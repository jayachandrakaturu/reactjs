...
fdescribe('NavaidComponent', () => {
    ...
    describe('frequency / agencyPhoneNumber validation switching', () => {
        ...
        it('should set required validator on frequency and clear validators on agencyPhoneNumber when frequency has value and phone is empty', fakeAsync(() => {
            ...
            // Set phone to empty first
            phone.setValue('')
            tick()

            // Now set frequency to a value - this triggers the valueChanges subscription
            frequency.setValue('118.5')
            tick()

            // Verify frequency has required validator by testing it errors when empty
            frequency.setValue('')
            frequency.updateValueAndValidity()
            ...
            // Verify phone has no validators - should be valid even when empty
            phone.setValue('')
            phone.updateValueAndValidity()
        ...
        it('should clear frequency validators and set phone validators when phone has value', fakeAsync(() => {
            ...
            // Set frequency to empty first
            frequency.setValue('')
            tick()

            // Now set phone to a valid value - this triggers the valueChanges subscription
            phone.setValue('555-123-4567')
            tick()

            // Verify phone has required and pattern validators
            phone.setValue('')
            phone.updateValueAndValidity()
            ...
            // Verify frequency has no validators - should be valid even when empty
            frequency.setValue('')
            frequency.updateValueAndValidity()
            expect(frequency.valid).toBeTrue()
            expect(frequency.errors).toBeNull()
        }))
        
        it('should set both required validators when both frequency and phone are empty', fakeAsync(() => {
            fixture = TestBed.createComponent(NavaidComponent)
            component = fixture.componentInstance
            component['form'] = new FormGroup({
                scenarioData: new FormGroup({}),
            ...
            // Now clear both - this triggers the valueChanges subscription
            frequency.setValue('')
            tick()
            phone.setValue('')
            tick()

            // Verify both have required validators
            frequency.updateValueAndValidity()
            phone.updateValueAndValidity()
        ...
        it('should handle trimming of whitespace in frequency value', fakeAsync(() => {
            fixture = TestBed.createComponent(NavaidComponent)
            component = fixture.componentInstance
            component['form'] = new FormGroup({
                scenarioData: new FormGroup({}),
            ...
            // Set frequency with only whitespace - should be treated as empty
            frequency.setValue('   ')
            tick()

            // Both should have required validators since frequency is effectively empty
            frequency.updateValueAndValidity()
            phone.updateValueAndValidity()
        ...
        it('should handle trimming of whitespace in phone value', fakeAsync(() => {
            fixture = TestBed.createComponent(NavaidComponent)
            component = fixture.componentInstance
            component['form'] = new FormGroup({
                scenarioData: new FormGroup({}),
            ...
            // Set frequency to empty
            frequency.setValue('')
            tick()

            // Set phone with only whitespace - should be treated as empty
            phone.setValue('   ')
            tick()

            // Both should have required validators since phone is effectively empty
            frequency.updateValueAndValidity()
            phone.updateValueAndValidity()
